...
| [LangGraph](docs/zh/langgraph/index.md) | 14 章 | LangGraph 1.2（2026-09-17 官方文档核验） | 状态/Reducer/条件路由/工具调用/检查点/中断审批/流式/子图/Functional API/容错 · 三实战：本地问答图 / 多智能体工单路由 / 容错审批流水线 |
| [Deep Agents](docs/zh/deepagents/index.md) | 14 章 | Deep Agents 0.7.x（本地核验 0.7.15） | 文件工具/权限/沙箱/Skills/Memory/任务规划/子智能体/人工审批/流式 · 三实战：文件+Skills+子任务+审批闭环 / 代码库只读审查 / 研究流水线 |
...
九门智能体框架课程均配备**三章贯穿式综合实战**，覆盖不同场景与复杂度：
...
| [LangGraph](docs/zh/langgraph/index.md) | 有证据的本地问答图 | 多智能体工单路由 | 容错、审批与恢复流水线 |
| [Deep Agents](docs/zh/deepagents/index.md) | 文件 + Skills + 子任务 + 审批闭环 | 代码库只读审查助手 | 规划、委派与审批的研究流水线 |
