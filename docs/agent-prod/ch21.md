...
> 📌 本章综合了本课程的多个章节：**FastAPI 生产基础**（[FastAPI ch22](/fastapi/ch22)）、**AI SDK Provider 管理**（[AI SDK ch03](/ai-sdk/ch03)）、**LangGraph 流式输出**（[Agent 工程 ch08](/agent/ch08)）、**可观测性**（[Langfuse](/agent-prod/ch14)）。如遇到不熟悉的知识点，可回看对应章节。
...
- [Langfuse 可观测性](/ai-sdk/ch14) — 追踪与评估
