...
- 与 [pytest](/pytest/) 第 19 章（Web 服务测试）衔接；
- 与 [FastAPI](/fastapi/) 第 20 章（测试）配合，形成完整的 Web 测试技能栈；
- 与 [Playwright](/playwright/) 互补——Playwright 测浏览器，requests/httpx 测 API。
...
- 建议先完成本站 [pytest 前 6 章](/pytest/) 了解测试基础。
