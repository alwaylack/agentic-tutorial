      ...
      themeConfig: {
        nav: [
          ...
          },
          {
            text: '🤖 智能体框架',
            items: [
              { text: 'LangGraph', link: '/zh/langgraph/' },
              { text: 'Deep Agents', link: '/zh/deepagents/' },
        ...
        sidebar: {
      '/zh/langgraph/': [{ text: 'LangGraph 教程（14 章）', items: [{ text: '课程导学', link: '/zh/langgraph/' }, { text: '01. 先运行一张没有模型的图', link: '/zh/langgraph/ch01' }, { text: '02. 状态、Reducer 与并发合并', link: '/zh/langgraph/ch02' }, { text: '03. 条件路由与有界循环', link: '/zh/langgraph/ch03' }, { text: '04. 消息状态与工具调用闭环', link: '/zh/langgraph/ch04' }, { text: '05. 检查点、线程与跨会话记忆', link: '/zh/langgraph/ch05' }, { text: '06. 人工审批、中断与恢复', link: '/zh/langgraph/ch06' }, { text: '07. 流式输出与前端事件协议', link: '/zh/langgraph/ch07' }, { text: '08. 子图与明确的输入输出边界', link: '/zh/langgraph/ch08' }, { text: '09. Functional API 与任务重放', link: '/zh/langgraph/ch09' }, { text: '10. 容错、重试与幂等性', link: '/zh/langgraph/ch10' }, { text: '11. 测试状态转移与回归边界', link: '/zh/langgraph/ch11' }, { text: '12. 综合实战：有证据的本地问答图', link: '/zh/langgraph/ch12' },
    { text: '13. 综合实战二：多智能体工单路由', link: '/zh/langgraph/ch13' },
    { text: '14. 综合实战三：容错、审批与恢复', link: '/zh/langgraph/ch14' }] }],
      '/zh/deepagents/': [{ text: 'Deep Agents 教程（14 章）', items: [{ text: '课程导学', link: '/zh/deepagents/' }, { text: '01. 第一个 Deep Agent 与文件工具', link: '/zh/deepagents/ch01' }, { text: '02. 模型接入与字符串路由', link: '/zh/deepagents/ch02' }, { text: '03. 文件系统权限与路径边界', link: '/zh/deepagents/ch03' }, { text: '04. 沙箱执行与 Shell 工具', link: '/zh/deepagents/ch04' }, { text: '05. Skills 与渐进披露', link: '/zh/deepagents/ch05' }, { text: '06. Memory 与 AGENTS.md', link: '/zh/deepagents/ch06' }, { text: '07. 上下文压缩与 Prompt Caching', link: '/zh/deepagents/ch07' }, { text: '08. 任务规划与 write_todos', link: '/zh/deepagents/ch08' }, { text: '09. 子智能体与上下文隔离', link: '/zh/deepagents/ch09' }, { text: '10. 人工审批与条件中断', link: '/zh/deepagents/ch10' }, { text: '11. 流式输出与子智能体事件', link: '/zh/deepagents/ch11' }, { text: '12. 综合实战：文件 + Skills + 子任务 + 审批', link: '/zh/deepagents/ch12' },
    { text: '13. 综合实战二：代码库只读审查助手', link: '/zh/deepagents/ch13' },
    { text: '14. 综合实战三：规划、委派与审批的研究流水线', link: '/zh/deepagents/ch14' }] }],
      ...
      themeConfig: {
        nav: [
          ...
          },
          {
            ...
            items: [
              { text: 'LangGraph', link: '/en/langgraph/' },
              { text: 'Deep Agents', link: '/en/deepagents/' },
        ...
        sidebar: {
      '/en/langgraph/': [{ text: 'LangGraph (14 chapters)', items: [{ text: 'Course Guide', link: '/en/langgraph/' }, { text: '01. Run a graph without a model', link: '/en/langgraph/ch01' }, { text: '02. State, reducers, and concurrent updates', link: '/en/langgraph/ch02' }, { text: '03. Conditional routing and bounded loops', link: '/en/langgraph/ch03' }, { text: '04. Messages and the tool-calling loop', link: '/en/langgraph/ch04' }, { text: '05. Checkpoints, threads, and cross-thread memory', link: '/en/langgraph/ch05' }, { text: '06. Human approval, interrupts, and resume', link: '/en/langgraph/ch06' }, { text: '07. Streaming and frontend event contracts', link: '/en/langgraph/ch07' }, { text: '08. Subgraphs and explicit boundaries', link: '/en/langgraph/ch08' }, { text: '09. Functional API and task replay', link: '/en/langgraph/ch09' }, { text: '10. Fault tolerance, retries, and idempotency', link: '/en/langgraph/ch10' }, { text: '11. Test transitions and regression boundaries', link: '/en/langgraph/ch11' }, { text: '12. Capstone: evidence-grounded local QA', link: '/en/langgraph/ch12' },
    { text: '13. Capstone 2: multi-agent ticket routing', link: '/en/langgraph/ch13' },
    { text: '14. Capstone 3: fault tolerance, approval, and resume', link: '/en/langgraph/ch14' }] }],
      '/en/deepagents/': [{ text: 'Deep Agents (14 chapters)', items: [{ text: 'Course Guide', link: '/en/deepagents/' }, { text: '01. Your first deep agent and its file tools', link: '/en/deepagents/ch01' }, { text: '02. Model routing and provider strings', link: '/en/deepagents/ch02' }, { text: '03. Filesystem permissions and path boundaries', link: '/en/deepagents/ch03' }, { text: '04. Sandbox execution and the shell tool', link: '/en/deepagents/ch04' }, { text: '05. Skills and progressive disclosure', link: '/en/deepagents/ch05' }, { text: '06. Memory and AGENTS.md', link: '/en/deepagents/ch06' }, { text: '07. Context compression and prompt caching', link: '/en/deepagents/ch07' }, { text: '08. Task planning and write_todos', link: '/en/deepagents/ch08' }, { text: '09. Subagents and context isolation', link: '/en/deepagents/ch09' }, { text: '10. Human-in-the-loop and conditional interrupts', link: '/en/deepagents/ch10' }, { text: '11. Streaming and subagent events', link: '/en/deepagents/ch11' }, { text: '12. Capstone: files + skills + delegation + approval', link: '/en/deepagents/ch12' },
    { text: '13. Capstone 2: read-only codebase audit assistant', link: '/en/deepagents/ch13' },
    { text: '14. Capstone 3: planning, delegation, and approval research pipeline', link: '/en/deepagents/ch14' }] }],
