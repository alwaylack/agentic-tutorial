...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      '/agno/': [{ text: 'Agno 3', items: [{ text: '0. Course Guide', link: '/en/agno/' }, { text: '01 Agent Application Development and Agno Overview', link: '/en/agno/ch01.html' }, { text: '02 Environment Setup and Your First Agent', link: '/en/agno/ch02.html' }, { text: '03 Running Agents and Parsing RunOutput', link: '/en/agno/ch03.html' }, { text: '04 Streaming Output and Real-Time Responses', link: '/en/agno/ch04.html' }, { text: '05 Structured Output with output_schema', link: '/en/agno/ch05.html' }, { text: '06 Prompt Engineering: instructions and the Description System', link: '/en/agno/ch06.html' }, { text: '07 Tools: How Built-in Toolkits Work and How to Use Them', link: '/en/agno/ch07.html' }, { text: '08 Custom Tools and Toolkit Development', link: '/en/agno/ch08.html' }, { text: '09 Agent Team Basics: Collaboration Patterns', link: '/en/agno/ch09.html' }, { text: '10 Team Advanced: Shared State and Member Communication', link: '/en/agno/ch10.html' }, { text: '11 Workflow Basics: Steps Orchestration', link: '/en/agno/ch11.html' }, { text: '12 Workflow Advanced: Parallel/Branch/Loop', link: '/en/agno/ch12.html' }, { text: '13 Multimodal Agents', link: '/en/agno/ch13.html' }, { text: '14 Session Management: session state and chat history', link: '/en/agno/ch14.html' }, { text: '15 Storage: Session Persistence', link: '/en/agno/ch15.html' }, { text: '16 Memory: User Profiles and Summaries', link: '/en/agno/ch16.html' }, { text: '17 Knowledge Bases and RAG Basics', link: '/en/agno/ch17.html' }, { text: '18 RAG Advanced: Agentic RAG and Hybrid Retrieval', link: '/en/agno/ch18.html' }, { text: '19 Reasoning and Thinking Models', link: '/en/agno/ch19.html' }, { text: '20 Skills: Pluggable Domain Capabilities', link: '/en/agno/ch20.html' }, { text: '21 Human-in-the-Loop and Guardrails', link: '/en/agno/ch21.html' }, { text: '22 MCP Protocol Integration', link: '/en/agno/ch22.html' }, { text: '23 AgentOS: Publishing Agents as Services', link: '/en/agno/ch23.html' }, { text: '24 Observability and Debugging', link: '/en/agno/ch24.html' }, { text: '25 Performance Optimization and Production Practice', link: '/en/agno/ch25.html' }, { text: '26 Capstone 1: Intelligent Data Analysis Assistant', link: '/en/agno/ch26.html' }, { text: '27 Capstone 2: Multi-Source Research Assistant Team', link: '/en/agno/ch27.html' }, { text: '28 Capstone 3: Customer-Support Knowledge Base Agent on AgentOS', link: '/en/agno/ch28.html' }] }],
      '/http/': [{ text: 'HTTP Requests', items: [{ text: '0. Course Guide', link: '/en/http/' }, { text: '01 The HTTP Client Ecosystem: An Overview', link: '/en/http/ch01.html' }, { text: '02 GET Requests and Response Handling', link: '/en/http/ch02.html' }, { text: '03 POST and Request Body Construction', link: '/en/http/ch03.html' }, { text: '04 Request Parameters: Headers, Cookies, Auth', link: '/en/http/ch04.html' }, { text: '05 Responses In Depth: Status Codes, JSON, Files', link: '/en/http/ch05.html' }, { text: '06 Sessions and Persistent Connections', link: '/en/http/ch06.html' }, { text: '07 Timeouts and Retry Mechanisms', link: '/en/http/ch07.html' }, { text: '08 Proxies and SSL/TLS Configuration', link: '/en/http/ch08.html' }, { text: '09 Exception Handling and Best Practices', link: '/en/http/ch09.html' }, { text: '10 httpx Introduction and Sync API', link: '/en/http/ch10.html' }, { text: '11 The AsyncClient', link: '/en/http/ch11.html' }, { text: '12 Concurrent Requests and Concurrency Control', link: '/en/http/ch12.html' }, { text: '13 HTTP/2 and WebSocket', link: '/en/http/ch13.html' }, { text: '14 Middleware and Event Hooks', link: '/en/http/ch14.html' }, { text: '15 pytest Integration Testing', link: '/en/http/ch15.html' }, { text: '16 Performance Optimization and Resource Management', link: '/en/http/ch16.html' }, { text: '17 API Client Encapsulation Patterns', link: '/en/http/ch17.html' }, { text: '18 Security Best Practices', link: '/en/http/ch18.html' }, { text: '19 Production Deployment and Monitoring', link: '/en/http/ch19.html' }, { text: '20 Capstone: GitHub API Client', link: '/en/http/ch20.html' }] }],
      '/agent-prod/': [{ text: 'Agent Engineering in Production', items: [{ text: '0. Course Guide', link: '/en/agent-prod/' }, { text: '01 Production Async Python and FastAPI', link: '/en/agent-prod/ch01.html' }, { text: '02 Message Queues: Redis Queue and Celery Worker', link: '/en/agent-prod/ch02.html' }, { text: '03 Distributed Coordination and Containerized Deployment Advanced', link: '/en/agent-prod/ch03.html' }, { text: '04 LangGraph Overview and StateGraph Introduction', link: '/en/agent-prod/ch04.html' }, { text: '05 State Management and Tool Calling', link: '/en/agent-prod/ch05.html' }, { text: '06 Conditional Edges, Subgraphs, and Modularity', link: '/en/agent-prod/ch06.html' }, { text: '07 Persistence: Checkpointer and Thread', link: '/en/agent-prod/ch07.html' }, { text: '08 Streaming Output and Interrupt Recovery', link: '/en/agent-prod/ch08.html' }, { text: '09 Deep Agents Introduction: create_deep_agent', link: '/en/agent-prod/ch09.html' }, { text: '10 Skills, Memory, and Approval Modes', link: '/en/agent-prod/ch10.html' }, { text: '11 Context Engineering: Truncation, Compaction, and Token Budgets', link: '/en/agent-prod/ch11.html' }, { text: '12 LLM-as-judge Evaluator', link: '/en/agent-prod/ch12.html' }, { text: '13 A/B Testing and Controlled Experiments', link: '/en/agent-prod/ch13.html' }, { text: '14 Langfuse + OpenTelemetry Integration', link: '/en/agent-prod/ch14.html' }, { text: '15 Multi-Model Gateways and Cost Optimization', link: '/en/agent-prod/ch15.html' }, { text: '16 AWS ECS/Fargate and S3', link: '/en/agent-prod/ch16.html' }, { text: '17 SQS Message Queue and DynamoDB', link: '/en/agent-prod/ch17.html' }, { text: '18 CloudWatch Monitoring and CI/CD', link: '/en/agent-prod/ch18.html' }, { text: '19 Extension 1: Complex Document Parsing Pipeline (PDF/PPT/OCR/Transcription)', link: '/en/agent-prod/ch19.html' }, { text: '20 Extension 2: Audio/Video Processing and Headless Rendering Pipeline (FFmpeg/OpenCV/Playwright)', link: '/en/agent-prod/ch20.html' }, { text: '21 Capstone 1: RAG Knowledge Base Agent', link: '/en/agent-prod/ch21.html' }, { text: '22 Capstone 2: Multi-Agent Ticket Handling System', link: '/en/agent-prod/ch22.html' }, { text: '23 Capstone 3: Full-Stack Agent Service', link: '/en/agent-prod/ch23.html' }] }],
        },
      '/pi/': [{ text: 'Pi Agent', items: [{ text: '0. Course Guide', link: '/en/pi/' }, { text: '01 What is Pi: Minimal Terminal Coding Agent', link: '/en/pi/ch01.html' }, { text: '02 Installation and Quick Start', link: '/en/pi/ch02.html' }, { text: '03 Providers and Models Configuration', link: '/en/pi/ch03.html' }, { text: '04 Interactive Modes: Editor/Commands/Shortcuts', link: '/en/pi/ch04.html' }, { text: '05 Session Management: Resume and Branch', link: '/en/pi/ch05.html' }, { text: '06 Context Compaction and Context Files', link: '/en/pi/ch06.html' }, { text: '07 Settings and Project Trust', link: '/en/pi/ch07.html' }, { text: '08 Prompt Templates', link: '/en/pi/ch08.html' }, { text: '09 Skills System', link: '/en/pi/ch09.html' }, { text: '10 Extensions Intro: TypeScript Extension API', link: '/en/pi/ch10.html' }, { text: '11 Extensions Advanced: Custom Tools and UI', link: '/en/pi/ch11.html' }, { text: '12 Themes Customization', link: '/en/pi/ch12.html' }, { text: '13 Pi Packages: Ecosystem and Distribution', link: '/en/pi/ch13.html' }, { text: '14 SDK Programmatic Embedding', link: '/en/pi/ch14.html' }, { text: '15 RPC Mode and Process Integration', link: '/en/pi/ch15.html' }, { text: '16 Print/JSON Mode and CI Automation', link: '/en/pi/ch16.html' }, { text: '17 Tool System and CLI Deep Dive', link: '/en/pi/ch17.html' }, { text: '18 Security Model and Environment Variables', link: '/en/pi/ch18.html' }, { text: '19 Multi-Agent Collaboration', link: '/en/pi/ch19.html' }, { text: '20 Observability and Debugging', link: '/en/pi/ch20.html' }, { text: '21 Multi-Session Collaboration: intercom and messenger', link: '/en/pi/ch21.html' }, { text: '22 Production Deployment', link: '/en/pi/ch22.html' }] }],
        // EN-SIDEBAR-END
