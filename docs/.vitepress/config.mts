  ...
  locales: {
    zh: {
      ...
      themeConfig: {
        ...
        sidebar: {
      '/zh/langgraph/': [{ text: 'LangGraph 教程（12 章）', items: [{ text: '课程导学', link: '/zh/langgraph/' }, { text: '01. 先运行一张没有模型的图', link: '/zh/langgraph/ch01' }, { text: '02. 状态、Reducer 与并发合并', link: '/zh/langgraph/ch02' }, { text: '03. 条件路由与有界循环', link: '/zh/langgraph/ch03' }, { text: '04. 消息状态与工具调用闭环', link: '/zh/langgraph/ch04' }, { text: '05. 检查点、线程与跨会话记忆', link: '/zh/langgraph/ch05' }, { text: '06. 人工审批、中断与恢复', link: '/zh/langgraph/ch06' }, { text: '07. 流式输出与前端事件协议', link: '/zh/langgraph/ch07' }, { text: '08. 子图与明确的输入输出边界', link: '/zh/langgraph/ch08' }, { text: '09. Functional API 与任务重放', link: '/zh/langgraph/ch09' }, { text: '10. 容错、重试与幂等性', link: '/zh/langgraph/ch10' }, { text: '11. 测试状态转移与回归边界', link: '/zh/langgraph/ch11' }, { text: '12. 综合实战：有证据的本地问答图', link: '/zh/langgraph/ch12' }] }],
      '/zh/deepagents/': [{ text: 'Deep Agents 教程（12 章）', items: [{ text: '课程导学', link: '/zh/deepagents/' }, { text: '01. 第一个 Deep Agent 与文件工具', link: '/zh/deepagents/ch01' }, { text: '02. 模型接入与字符串路由', link: '/zh/deepagents/ch02' }, { text: '03. 文件系统权限与路径边界', link: '/zh/deepagents/ch03' }, { text: '04. 沙箱执行与 Shell 工具', link: '/zh/deepagents/ch04' }, { text: '05. Skills 与渐进披露', link: '/zh/deepagents/ch05' }, { text: '06. Memory 与 AGENTS.md', link: '/zh/deepagents/ch06' }, { text: '07. 上下文压缩与 Prompt Caching', link: '/zh/deepagents/ch07' }, { text: '08. 任务规划与 write_todos', link: '/zh/deepagents/ch08' }, { text: '09. 子智能体与上下文隔离', link: '/zh/deepagents/ch09' }, { text: '10. 人工审批与条件中断', link: '/zh/deepagents/ch10' }, { text: '11. 流式输出与子智能体事件', link: '/zh/deepagents/ch11' }, { text: '12. 综合实战：文件 + Skills + 子任务 + 审批', link: '/zh/deepagents/ch12' }] }],
