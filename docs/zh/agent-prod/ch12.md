...
- **[Vercel AI SDK](/zh/ai-sdk/)** ch03：Provider 管理，用于配置 judge 模型的 API key
- **[Agent 工程](/zh/agent/)** ch12：CoT 推理，可应用于 judge 的思考链设计
- **[FastAPI](/zh/fastapi/)** ch22：Docker 部署，可将评估服务容器化
...
3. 将评估脚本改造为 FastAPI 接口，接受 `{question, context}` 输入，返回评估结果 JSON，参考 [FastAPI](/zh/fastapi/) ch01-06。
...
[上一章：上下文工程](/zh/agent-prod/ch11) | [下一章：A/B 测试与对照实验](/zh/agent-prod/ch13)
