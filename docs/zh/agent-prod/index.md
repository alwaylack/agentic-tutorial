...
| 阶段 | 章节 | 内容 | 前置链接 |
|---|---|---|---|
| 异步基础 | 01–03 | asyncio 深入、消息队列 Redis/Celery、分布式协调与 Docker | [FastAPI](/zh/fastapi/) ch01-22 |
| LangGraph 核心 | 04–08 | StateGraph、工具调用、子图、持久化、流式输出与中断恢复 | [Agent 工程](/zh/agent/) ch01-12 |
| Deep Agents | 09–11 | create_deep_agent、Skills/Memory、上下文工程 | [LangGraph](./ch04) |
| 评估与可观测 | 12–15 | LLM-as-judge、A/B 测试、Langfuse/OpenTelemetry、多网关成本优化 | [Vercel AI SDK](/zh/ai-sdk/) ch03 |
| 生产部署 | 16–18 | AWS ECS/Fargate、SQS/DynamoDB、CloudWatch/CI-CD | [FastAPI](/zh/fastapi/) ch22 |
| 多模态扩展 | 19–20 | 文档解析管线（PDF/PPT/OCR/转录）、音视频处理与无头渲染 | [Playwright](/zh/playwright/) 全课 |
...
- 建议配合 [Vercel AI SDK](/zh/ai-sdk/) 课程学习 Provider 管理部分。
