...
> Chapter goals:understand Playwright Principles of Auto-Waiting与五项 actionability 检查，知道每个操作到底在等什么，以及 timeout / force 的正确用法。
...
> 进入[第 5 章：Web-First Assertions with expect](./ch05)。
