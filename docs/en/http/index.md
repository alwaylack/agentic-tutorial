...
- Pairs with [pytest](/en/pytest/) chapter 19 (web service testing);
- Complements [FastAPI](/en/fastapi/) chapter 20 (testing) for a complete web-testing skill set;
- Complements [Playwright](/en/playwright/) — Playwright tests browsers, while requests/httpx test APIs.
...
- Completing the first six chapters of our [pytest course](/en/pytest/) first is recommended.

👉 Start from [Chapter 1](/en/http/ch01).
